    ...
    class Apriori
    {
        ...
        public void HashDB()//通过扫描数据库, 得到数据库的散列数值
        {
            ...
            string _strdata =
               ...
               System.Environment.CurrentDirectory, @"\database\testDB.mdb");
        ...
        //    //List<char> list = new List<char>(50);
        //    //for (int i = 0; i < A.Length; i++)
        //    //{
        //    //    list.Add(A.ElementAt(i));
        //    //}

        //    //for (int i = 0; i <B.Length;i++)
        //    //{
        //    //    if(!list.Contains(B.ElementAt(i)))
        //    //    {
        //    //        list.Add(B.ElementAt(i));
        //    //    }
        //    //}
        //    //list.Sort();
